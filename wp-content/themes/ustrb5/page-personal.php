<?php
/*
Template Name: Матрица Персональная
				...
				<article>
					<div class="card pe-4">
						<div class="card-body">
							...
							<form class="matr_form d-xl-flex my-2" action="/personal/" method="get">
									...
									<div class="col-12">
										...
										<div class="btn-group">
											<input id="s_male" type="radio" class="btn-check sev_check" name="gender" value="male" autocomplete="off" checked />
												<label id="l_male" class="btn btn-default" for="s_male">Мужчина</label>
											<input id="s_female" type="radio" class="btn-check sev_check" name="gender" value="female" autocomplete="off" />
												<label id="l_female" class="btn btn-default" for="s_female">Женщина</label>
											<input id="s_trans" type="radio" class="btn-check sev_check" name="gender" value="trans" autocomplete="off" />
												<label id="l_trans" class="btn btn-default" for="s_trans">Инопланетянин</label>
										</div>
									</div>
								</div>
