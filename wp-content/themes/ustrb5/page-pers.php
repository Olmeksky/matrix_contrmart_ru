				...
				<aside>
					<div class="banners">
						<div class="banner-item">
							<img src="<? echo get_stylesheet_directory_uri(); ?>/assets/css/Banner_matrix.jpg">
						</div>
					</div>
				</aside>
			</div>
				...
				<div class="scheme">
					<div class="sceme_wraper">
						<div class="schema_fon">
							<img class="schema_fon" src="<? echo get_stylesheet_directory_uri(); ?>/assets/img/SchemeMatrix01.svg" alt="">
						</div>
						<div class="sheme_r">
							<div class="A">A</div>
							<div class="B">B</div>
