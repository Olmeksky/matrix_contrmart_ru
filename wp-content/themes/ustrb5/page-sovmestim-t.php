<?php
/*
Template Name: Матрица Совместимости (темная)
Template Post Type: post, page, matrix_fate
*/
?>
<?php get_header('so-dark'); ?>
		...
		<div class="row">
			<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
				<article>
					<div class="card pe-4">
						<div class="card-body">
							<h1 class="card-title my-2">Расчет совместимость</h1>
							<h5 class="card-subtitle p-2 ms-4">Рассчитайте матрицу совместимости.</h5>
							<hr class="hr hr-blurry" />
							<form class="matr-form d-xl-flex my-2" action="/sovmestimost-dark/" method="get">
								<div class="row">
