<?php
/*
Template Name: Матрица Персональная (темная)
...
<?php get_header('dark'); ?>
	...
	<section>
		<div class="row">
			<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
				<article>
					<div class="card pe-4">
						<div class="card-body">
							<h1 class="card-title my-2">Персональный расчет</h1>
							<h5 class="card-subtitle p-2 ms-4">Рассчитайте персональную матрицу судьбы.</h5>
							<form class="matr_form d-xl-flex my-2" action="/personal-dark/" method="get">
								
								<div class="row">
									<div class="col-12">
										<div class="matr_input">
											<input type="text" class="form-control-lg my-3 w-100" id="checkName" name="firstname" placeholder="Ваше имя">
											<input type="date" class="form-control-lg my-3 w-100" id="checkDate" name="birthday" placeholder="Дата вашего рождения">
											<button type="submit" class="btn btn-warning my-3 w-100">Расчет</button>
										</div>
									</div>
									<div class="col-12">
										<div class="btn-group">
											<input id="s_male" type="radio" class="btn-check sev_check" name="gender" value="male" autocomplete="off" checked />
											<label class="btn btn-default matr_label" for="s_male">Мужчина</label>
											<input id="s_female" type="radio" class="btn-check sev_check" name="gender" value="female" autocomplete="off" />
											<label class="btn btn-default matr_label" for="s_female">Женщина</label>
											<input id="s_trans" type="radio" class="btn-check sev_check" name="gender" value="trans" autocomplete="off" />
											<label class="btn btn-default matr_label" for="s_trans">Инопланетянин</label>
										</div>
									</div>
								</div>
		...
		<div class="col-12">
			<article>
				<h1 class="card-title my-2">Схема матрицы судьбы расчет</h1>
				...
				<div class="scheme">
					<div class="sceme_wraper">
						<div class="schema_fon">
							<img class="schema_fon" src="/wp-content/themes/ustrb5/assets/img/SchemeMatrix01_black.svg" alt="">
						</div>
						<div class="sheme_r">
							<div class="A">A</div>
							<div class="B">B</div>
		...
		<div class="col-12">
			<article>
				<div class="container prdnaznachenie">
					<h1 class="card-title my-2">Предназначение</h1>
					<div class="row">
						<div class="col-6 w-50 g-2 p-2">
							<h5 class="card-subtitle p-2 ms-4">Поиск себя:</h5>
							<p class="podzagolovok">Соединение мужского и женского. Выстраивание взаимоотношений. Способности, навыки, умения.</p>
							<div class="row">
								<div class="col-6 text-end">
									<h5 class="card-subtitle p-2 ms-4">Небо: <span class="NEBO">Ne</span></h5>
									<h5 class="card-subtitle p-2 ms-4">Земля: <span class="ZEML">Ze</span></h5>
								</div>
								<div class="col-2 text-center align-middle">
									<div class="fig-scob">&#125;</div>
								</div>
								<div class="col-3 text-start">
									<h5 class="card-subtitle p-2 ms-4"><span class="SEB">Se</span></h5>
								</div>
							</div>
						</div>
						<div class="col-6 w-50 g-2 p-2">
							<h5 class="card-subtitle p-2 ms-4">Социализация:</h5>
							<p class="podzagolovok">Социальная и родовые системы. Результаты и признание в социуме.</p>
							<div class="row">
								<div class="col-6 text-end">
									<h5 class="card-subtitle p-2 ms-4">Мужское: <span class="RPM">M</span></h5>
									<h5 class="card-subtitle p-2 ms-4">Женское: <span class="RPZH">Zh</span></h5>
								</div>
								<div class="col-2 text-center align-middle">
									<div class="fig-scob">&#125;</div>
								</div>
								<div class="col-3 text-start">
									<h5 class="card-subtitle p-2 ms-4"><span class="SOC">So</span></h5>
								</div>
							</div>
						</div>
						<div class="col-6 w-50 g-2 p-2">
							<h5 class="card-subtitle p-2 ms-4">Духовная гармония:</h5>
							<p class="podzagolovok">Духовный зачет. Кто я для бога? Где божественное во мне?</p>
							<h5 class="card-subtitle p-2 ms-4">Результат: <span class="DUH">Du</span></h5>
						</div>
						<div class="col-6 w-50 g-2 p-2">
							<h5 class="card-subtitle p-2 ms-4">Планетарное:</h5>
							...
							<h5 class="card-subtitle p-2 ms-4">Результат: <span class="PLANET">Pl</span></h5>
						</div>
					</div>
				</div>
